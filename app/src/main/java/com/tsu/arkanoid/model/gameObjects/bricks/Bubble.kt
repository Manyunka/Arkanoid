...
class Bubble(x: Float, y: Float, width: Int, height: Int, level: Int, res: Resources) :
    Brick(x, y, level) {
    private var brick: Bitmap
    private val level1Bitmap = BitmapFactory.decodeResource(res,
        R.drawable.bubble_1
    )
    private val level2Bitmap = BitmapFactory.decodeResource(res,
        R.drawable.bubble_2
    )
    private val level3Bitmap = BitmapFactory.decodeResource(res,
        R.drawable.bubble_3
    )
    private val level4Bitmap = BitmapFactory.decodeResource(res,
        R.drawable.bubble_4
    )
